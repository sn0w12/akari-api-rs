...
#[derive(Debug, Serialize, Deserialize, ToSchema)]
pub struct MalMainPicture { pub medium: String, pub large: String }

#[derive(Debug, Serialize, Deserialize, ToSchema)]
#[serde(rename_all = "camelCase")]
pub struct MalListStatus {
    pub status: String,
    #[serde(alias = "is_rereading")] pub is_rereading: bool,
    #[serde(alias = "num_volumes_read")] pub num_volumes_read: i32,
    #[serde(alias = "num_chapters_read")] pub num_chapters_read: i32,
    pub score: i32,
    #[serde(alias = "updated_at")] pub updated_at: String,
}

#[derive(Debug, Serialize, Deserialize, ToSchema)]
#[serde(rename_all = "camelCase")]
pub struct MalPaging { pub next: Option<String> }

#[derive(Debug, Serialize, Deserialize, ToSchema)]
#[serde(rename_all = "camelCase")]
pub struct MalUser {
    pub id: i32, pub name: String,
    pub location: String,
    #[serde(alias = "joined_at")] pub joined_at: String,
}
